    ...
    <div class="row">
        <div class="col mr-auto ml-auto">
            ...
            <form class="form-group d-flex justify-content-center flex-column text-center" action="../build/components/process.php" method="post">
                ...
                <input class="form-control pb-2" type="text" value="<?php echo $link . "/story_html5.html";?>" name="link" required>
                ...
                <div class="input-group mb-2">
                    <input class="form-control pb-2" type="text"  value="<?php echo preg_replace("/[^0-9,.]/", "", $metaImport->project['duration']);?>" name="duration" required>
                ...
                <input class="form-control pb-2" type="text" value="<?php echo $metaImport->project[0]->description[0];?>" name="descr" required>
                ...
                <input class="form-control pb-2" type="text" value="<?php echo $metaImport->project[0]->author['name'];?>" name="author" required>
